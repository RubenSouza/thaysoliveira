...
"[project]/src/app/components/ClientLogic.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientLogic() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientLogic.useEffect": ()=>{
            /* --- Lógica do Botão Voltar ao Topo --- */ const backToTopBtn = document.getElementById('back-to-top-btn');
            const handleScroll = {
                "ClientLogic.useEffect.handleScroll": ()=>{
            ...
            /* --- Lógica do Menu Hambúrguer --- */ const hamburger = document.getElementById('hamburger-menu');
            ...
            const handleHamburgerClick = {
                "ClientLogic.useEffect.handleHamburgerClick": ()=>{
            ...
            const handleDocumentClick = {
                "ClientLogic.useEffect.handleDocumentClick": (event)=>{
                    const isMenuOpen = navLinks.classList.contains('nav-active');
            ...
            }["ClientLogic.useEffect.handleDocumentClick"];
            document.addEventListener('click', handleDocumentClick);
            /* --- LÓGICA DO CARROSSEL --- */ function setupCarousel(carouselId, prevBtnId, nextBtnId, itemsPerViewDesktop, itemsPerViewMobile, autoScrollInterval) {
                ...
                carouselItems.forEach({
                    "ClientLogic.useEffect.setupCarousel": (item)=>{
                        carousel.appendChild(item.cloneNode(true));
                    }
                }["ClientLogic.useEffect.setupCarousel"]);
                let currentIndex = totalItems;
                let itemsPerView = window.innerWidth <= 768 ? itemsPerViewMobile : itemsPerViewDesktop;
                let intervalId;
                function updateCarousel() {
                    let transition = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
                    ...
                    carousel.style.transform = "translateX(-".concat(currentIndex * itemWidth, "%)");
                    Array.from(carousel.children).forEach({
                        "ClientLogic.useEffect.setupCarousel.updateCarousel": (item)=>{
                            item.style.flex = "0 0 ".concat(itemWidth, "%");
                        }
                    }["ClientLogic.useEffect.setupCarousel.updateCarousel"]);
                }
                function showNext() {
                    ...
                    if (currentIndex >= totalItems * 2 - itemsPerView) {
                        setTimeout({
                            "ClientLogic.useEffect.setupCarousel.showNext": ()=>{
                                currentIndex = totalItems - itemsPerView;
                                updateCarousel(false);
                            }
                        }["ClientLogic.useEffect.setupCarousel.showNext"], 500);
                    }
                }
                function showPrev() {
                    ...
                    if (currentIndex < 1) {
                        setTimeout({
                            "ClientLogic.useEffect.setupCarousel.showPrev": ()=>{
                                currentIndex = totalItems - 1;
                                updateCarousel(false);
                            }
                        }["ClientLogic.useEffect.setupCarousel.showPrev"], 500);
                    }
                }
                ...
                const handleResize = {
                    "ClientLogic.useEffect.setupCarousel.handleResize": ()=>{
                ...
                return ({
                    "ClientLogic.useEffect.setupCarousel": ()=>window.removeEventListener('resize', handleResize)
                })["ClientLogic.useEffect.setupCarousel"];
            }
            ...
            /* --- LÓGICA DO FORMULÁRIO DE CONTATO --- */ const contactForm = document.getElementById('contact-form-id');
            const handleFormSubmit = {
                "ClientLogic.useEffect.handleFormSubmit": function(event) {
                    ...
                    whatsappMessage += "*Nome:* ".concat(name, "\n");
                    whatsappMessage += "*E-mail:* ".concat(email, "\n\n");
                    whatsappMessage += "*Mensagem:*\n".concat(message);
                    const encodedMessage = encodeURIComponent(whatsappMessage);
                    const whatsappUrl = "https://wa.me/".concat(phoneNumber, "?text=").concat(encodedMessage);
                    window.open(whatsappUrl, '_blank');
                }
            }["ClientLogic.useEffect.handleFormSubmit"];
            if (contactForm) {
                contactForm.addEventListener('submit', handleFormSubmit);
            }
            /* --- LÓGICA PARA IMPEDIR INTERAÇÃO COM IMAGENS --- */ const handleContextMenu = {
                "ClientLogic.useEffect.handleContextMenu": (event)=>{
                    if (event.target.tagName === 'IMG') {
                        event.preventDefault();
                    }
                }
            }["ClientLogic.useEffect.handleContextMenu"];
    ...
    }["ClientLogic.useEffect"], []); // O array vazio [] garante que o useEffect rode apenas uma vez
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$script$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/app/components/ClientLogic.js",
                lineNumber: 256,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$script$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(ClientLogic, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ClientLogic;
var _c;
__turbopack_context__.k.register(_c, "ClientLogic");
...
//# sourceMappingURL=_c370a22e._.js.map